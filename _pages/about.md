...
<strong>About Me</strong>: I am a staff data scientist in Walmart Inc. Previously, I got my Ph.D.  from the EECS department at  <a href="https://www.uark.edu">University of Arkansas</a>, advised by <a href="https://engineering.uark.edu/electrical-engineering-computer-science/computer-science-faculty/uid/lz006/name/Lu+Zhang/">Prof. Lu Zhang</a>. And I obtained my M.S. and B.ENG. from the college of computer at <a href="https://en.scu.edu.cn">Sichuan University</a> in China.

<strong>Research Interest</strong>: Currently, I have been working on Agents and RAGs. During my PhD, my research primarily focused on fair machine learning and causal inference. Specifically, I proposed various fairness algorithms to achieve long-term fairness in sequential decision-making. My interests also include LLMs and reinforcement learning.
